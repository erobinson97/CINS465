#!/Users/bherring/opt/anaconda3/bin/python
import sys
import os
import filecmp
...
def run_test(test_name):
    ...
    command = "python filter.py < {} | python sort.py | python uniq.py | python pig_latin.py | python pig_latin_undo.py > {}".format(input_file, output_file)
    print(command)
    os.system(command)
